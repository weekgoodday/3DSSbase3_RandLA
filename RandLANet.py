...
class Network(nn.Module):
    ...
    def __init__(self, config):
        ...
        d_in = 8
        for i in range(self.config.num_layers): #在这里增加的维度
    ...
    def forward(self, end_points):
        features = end_points['features']  # Batch*channel*npoints (20, 3, 45046)
...
def compute_loss(end_points, cfg):
    logits = end_points['logits'] # 20, 19, 45046
    labels = end_points['labels'] # 20, 45056
